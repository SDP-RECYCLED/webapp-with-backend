...
def test_serialize_classification():
    ...
    assert serialize_classification_data(classification_data) == {"image_name": image_name, "item_class": item_class, "item_confidence": item_confidence, "bin_id": bin_id}
...
def test_register_classification_data(client, mocker):
    ...
    assert res.json == {"image_name": image_name, "item_class": item_class, "item_confidence": item_confidence, "bin_id": bin_id}
