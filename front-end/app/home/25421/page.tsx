...
export default function Home() {
    ...
    return (
      <div className="container mx-auto py-10 px-4 max-w-8xl">
        <div className="m-10"> 
            <h1 className="mx-8 mb-6 mt-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-5xl">Meeting Room<span className="text-sm text-gray-500 ml-4 font-thin">#25421</span></h1>
